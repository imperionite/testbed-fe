            ...
            input: {
              endAdornment: (
                <InputAdornment position="end">
                  <IconButton onClick={() => togglePassword(visibilityKey)} edge="end">
                    {showPassword[visibilityKey] ? <VisibilityOff /> : <Visibility />}
                  </IconButton>
                </InputAdornment>
              ),
            },
      ...
      >
        ...
        >
          ...
          <Typography color="text.secondary">
            You are using a temporary password assigned by an administrator. Please create a new
          ...
          {renderPasswordField('newPassword', 'New Password', 'new', 'new-password')}
