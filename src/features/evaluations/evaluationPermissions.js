import { FIELD_RULES, MODES, ROLES, evaluationFormConfig } from './form/formConfig'
...
export function getEvaluationManagementPermissions(role) {
  ...
  return {
    ...
    canViewInternEvaluationsList:
      isInternship_Coordinator || isStudent || isHTE_Supervisor || isFaculty_Adviser || isAdmin,
...
export function getFieldRule(field, role, mode) {
  ...
  const roleRules = Array.isArray(field.rbac) ? Object.assign({}, ...field.rbac) : field.rbac
