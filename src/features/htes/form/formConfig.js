...
export const hteFormConfig = [
  {
    ...
    label: 'ID',
    type: 'text',
    rbac: adminAndCoordinatorRules(FIELD_RULES.HIDDEN, FIELD_RULES.READONLY, FIELD_RULES.READONLY),
  },
  {
    name: 'created_at',
    label: 'Created At',
  ...
  },
  {
    ...
    label: 'Status',
    type: 'status',
    rbac: adminAndCoordinatorRules(FIELD_RULES.HIDDEN, FIELD_RULES.EDITABLE, FIELD_RULES.READONLY),
  },
]
