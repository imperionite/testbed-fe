import { FIELD_RULES, MODES, ROLES, hteFormConfig as hteFormConfig } from './form/formConfig'
...
export function getVisibleHteFields(role, mode) {
  return hteFormConfig.filter((field) => getFieldRule(field, role, mode) !== FIELD_RULES.HIDDEN)
}
