...
describe('InternshipModal mode behavior', () => {
  it('shows Add New Intern title in create mode', () => {
    const { getByText } = render(
      <QueryClientProvider client={queryClient}>
        <InternshipModal open mode="create" onClose={() => {}} />
      </QueryClientProvider>,
    )
  ...
  it('shows View Internship title in view mode', () => {
    const { getByText } = render(
      <QueryClientProvider client={queryClient}>
        <InternshipModal open mode="view" internship={sampleInternship} onClose={() => {}} />
      </QueryClientProvider>,
    )
  ...
  it('shows Edit Internship title in edit mode', () => {
    const { getByText } = render(
      <QueryClientProvider client={queryClient}>
        <InternshipModal open mode="edit" internship={sampleInternship} onClose={() => {}} />
      </QueryClientProvider>,
    )
